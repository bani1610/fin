<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="universitas" class="block mt-1 w-full" type="text" name="universitas" :value="old('universitas')" required autocomplete="universitas" />
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-sky-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
